...
func (_m *MockWriter) Create(ctx context.Context, u *models.UserCreate) (models.ID, error) {
	ret := _m.Called(ctx, u)
...
func (_c *MockWriter_Create_Call) Run(run func(ctx context.Context, u *models.UserCreate)) *MockWriter_Create_Call {
...
func (_c *MockWriter_Create_Call) Return(_a0 models.ID, _a1 error) *MockWriter_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWriter_Create_Call) RunAndReturn(run func(context.Context, *models.UserCreate) (models.ID, error)) *MockWriter_Create_Call {
	_c.Call.Return(run)
	return _c
}
