...
func (_m *MockReader) All(ctx context.Context) (*[]models.User, error) {
	ret := _m.Called(ctx)
...
func (_c *MockReader_All_Call) Return(_a0 *[]models.User, _a1 error) *MockReader_All_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReader_All_Call) RunAndReturn(run func(context.Context) (*[]models.User, error)) *MockReader_All_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: ctx, id
func (_m *MockReader) Get(ctx context.Context, id models.ID) (*models.User, error) {
...
func (_c *MockReader_Get_Call) Run(run func(ctx context.Context, id models.ID)) *MockReader_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReader_Get_Call) Return(_a0 *models.User, _a1 error) *MockReader_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReader_Get_Call) RunAndReturn(run func(context.Context, models.ID) (*models.User, error)) *MockReader_Get_Call {
	_c.Call.Return(run)
	return _c
}
