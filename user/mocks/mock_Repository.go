...
func (_m *MockRepository) Create(u *user.User) (user.ID, error) {
	ret := _m.Called(u)
...
func (_c *MockRepository_Create_Call) Run(run func(u *user.User)) *MockRepository_Create_Call {
...
func (_c *MockRepository_Create_Call) RunAndReturn(run func(*user.User) (user.ID, error)) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
