...
func (_m *MockWriter) Create(u *user.UserCreate) (user.ID, error) {
	ret := _m.Called(u)
...
func (_c *MockWriter_Create_Call) Run(run func(u *user.UserCreate)) *MockWriter_Create_Call {
...
func (_c *MockWriter_Create_Call) RunAndReturn(run func(*user.UserCreate) (user.ID, error)) *MockWriter_Create_Call {
	_c.Call.Return(run)
	return _c
}
